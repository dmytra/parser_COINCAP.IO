...
//    property var dataB: [] // [28,48,40,19,96,27,100,11]
...
//                }
                ...
                Button {
                    id: appBottonText13
                    text: "GET MAX NEW DATA  api.coincap.io/v2/assets"
...
//                            timestamp[7] = mydb.searchIndexDatatime("volumeUsd24Hr", 11.toString(), i);
                            ...
                            timestamp[8] =  mydb.searchIndexDatatime("priceUsd", spinbox.value.toString(), i);
...
//                            timestamp[11] = mydb.searchIndexDatatime("explorer", spinbox.value.toString(), i);
                            ...
                            dataA[i] = i;
                            dataB[i]= 10*(parseInt(tmp, 10) - parseInt(timestamp[8], 10));
//                            console.log(dataA[i]);
//                            console.log(dataB[i]);
                            }
